...
use Products\ProductsBundle\Entity\Category;
use Products\ProductsBundle\Entity\Product;
use Products\ProductsBundle\Entity\ProductCategory;
use Products\ProductsBundle\Form\ProductType;
...
class ProductsController extends Controller
{
    public function indexAction()
    {
        ...
        $products = $em->getRepository('ProductsProductsBundle:Product')->findBy(array('user' => $user->getUserId()), array('product_id' => 'DESC'));

        //Retrieving products' categories
        foreach ($products as $product) {
            $categories = $em->getRepository('ProductsProductsBundle:Category')->getCategoriesForProduct($product->getProductId());
            // dump($categories);
    ...
    public function createAction(Request $request)
    {
        ...
        //preparing form
        $form = $this->createForm('Products\ProductsBundle\Form\ProductType', $product);
        ...
        return $this->render('ProductsProductsBundle:Products:addProduct.html.twig', array(
            'product' => $product,
    ...
    public function deleteAction($product_id)
    {
        ...
        $product = $em->getRepository('ProductsProductsBundle:Product')->findOneBy(array('user' => $user->getUserId(),
        ...
        $categories = $em->getRepository('ProductsProductsBundle:Category')->getCategoriesForProduct($product_id);
    ...
    public function editAction($product_id, Request $request)
    {
        ...
        return $this->render('ProductsProductsBundle:Products:editProduct.html.twig', array(
            'form' => $form->createView(),
            'product' => $product,
